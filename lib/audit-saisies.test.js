...
describe('detecterTrousCanal', () => {
  ...
  it('entrees(source=uber_eats) compense historique.uber=0 → pas d\'alerte', () => {
    const r = detecterTrousCanal({
      since: '2026-05-05',
      today: '2026-05-05',
      historique: [
      ...
      entrees: [
        { date: '2026-05-05', source: 'uber_eats', montant_ttc: 200 }
      ],
      ignores: []
    })
    expect(r.alertes).toHaveLength(0)
  ...
  it('historique.uber=0 ET pas d\'entrees → alerte', () => {
    const r = detecterTrousCanal({
      since: '2026-05-05',
      today: '2026-05-05',
      historique: [
  ...
  it('médiane intègre les entrees(uber_eats) quand historique.uber=0', () => {
    const r = detecterTrousCanal({
      since: '2026-05-05',
      today: '2026-05-05',
      historique: [
        { date: '2026-04-07', uber: 0 },
        { date: '2026-04-14', uber: 0 },
        { date: '2026-04-21', uber: 0 },
        { date: '2026-04-28', uber: 0 },
        { date: '2026-05-05', uber: 0 }
      ],
      entrees: [
        { date: '2026-04-07', source: 'uber_eats', montant_ttc: 250 },
        { date: '2026-04-14', source: 'uber_eats', montant_ttc: 220 },
        { date: '2026-04-21', source: 'uber_eats', montant_ttc: 280 },
        { date: '2026-04-28', source: 'uber_eats', montant_ttc: 240 }
      ],
      ignores: []
    })
    expect(r.alertes).toHaveLength(1)
    expect(r.alertes[0].sousTexte).toContain('245')
  })
})
