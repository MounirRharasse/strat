...
// Lot 11 Charges Récurrentes V1.1 : renommé CATEGORIES_CHARGES_FIXES → CATEGORIES_NON_CONSO
// pour lever l'ambiguïté avec la section UI "Frais fixes" du P&L (qui ne contient que 6
// catégories : loyers_charges, honoraires, redevance_marque, prestations_operationnelles,
// frais_divers, autres_charges). Cette constante regroupe TOUT sauf consommations
// (= coûts variables / matières premières) — utilisée pour le seuil de rentabilité.
//
// Alias CATEGORIES_CHARGES_FIXES gardé pour rétro-compat callers externes (à retirer V1.2).
export const CATEGORIES_NON_CONSO = [
...
export const CATEGORIES_CHARGES_FIXES = CATEGORIES_NON_CONSO  // alias rétro-compat
