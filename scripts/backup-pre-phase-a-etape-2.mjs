// Backup JSON local pré-import Phase A étape 2 (backfill KS2).
// LECTURE PURE — aucune écriture nulle part.
//
// Tables à dumper :
//   - historique_ca, entrees (legacy non touchés mais backupés par défense en profondeur)
//   - sources (devrait avoir 2 rows seed Krousty depuis étape 1)
//   - ventes_par_source, paiements_caisse (devraient être vides avant backfill)
//
// Sortie :
//   /Users/mRharasse/Downloads/strat-backup-pre-phase-a-etape-2-2026-05-03.json
//
// Format identique à backup-pre-phase-a-etape-1.mjs.
...
const TABLES = [
  'historique_ca', 'entrees',
  'sources', 'ventes_par_source', 'paiements_caisse',
]
const PAGE_SIZE = 1000
const OUT_PATH = '/Users/mRharasse/Downloads/strat-backup-pre-phase-a-etape-2-2026-05-03.json'
...
const dump = {
  metadata: {
    ...
    snapshot_phase: 'pre-phase-a-etape-2',
    note: 'Backup avant backfill KS2 vers ventes_par_source + paiements_caisse',
  },
  tables: {},
}

console.log('Dump pré-import Phase A étape 2')
