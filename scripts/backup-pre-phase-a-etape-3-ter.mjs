// Backup JSON local pré-rerun Phase A étape 3-ter (classifier paramétrable F10).
...
//   - ventes_par_source (devrait avoir 1 488 rows = 744 popina + 744 uber_eats post-étape 3-bis)
//   - paiements_caisse (devrait avoir 744 rows post-étape 3)
//
// Sortie :
//   /Users/mRharasse/Downloads/strat-backup-pre-phase-a-etape-3-ter-2026-05-04.json
...
const OUT_PATH = '/Users/mRharasse/Downloads/strat-backup-pre-phase-a-etape-3-ter-2026-05-04.json'
...
const dump = {
  metadata: {
    ...
    snapshot_phase: 'pre-phase-a-etape-3-ter',
    note: 'Backup avant re-run du script étape 3 avec classifier paramétrable (F10), backfill rétroactif paiements_caisse',
  },
  tables: {},
}

console.log('Dump pré-rerun Phase A étape 3-ter')
