// Backup JSON local pré-import Phase A étape 3 (backfill API Popina).
...
//   - ventes_par_source (devrait avoir 544 rows post-étape 2 KS2)
//   - paiements_caisse (devrait avoir 272 rows post-étape 2 KS2)
//
// Sortie :
//   /Users/mRharasse/Downloads/strat-backup-pre-phase-a-etape-3-2026-05-04.json
...
const OUT_PATH = '/Users/mRharasse/Downloads/strat-backup-pre-phase-a-etape-3-2026-05-04.json'
...
const dump = {
  metadata: {
    ...
    snapshot_phase: 'pre-phase-a-etape-3',
    note: 'Backup avant backfill API Popina (16/01/2025 → 02/05/2026) vers ventes_par_source + paiements_caisse',
  },
  tables: {},
}

console.log('Dump pré-import Phase A étape 3')
